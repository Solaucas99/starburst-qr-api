...
class CodeSendUpdateVisitorMailJob implements IJobs {
  public options: JobOptions = jobOptions;
  public key: TQueuesName = 'CodeSendUpdateVisitorMail';
...
export default new CodeSendUpdateVisitorMailJob(NodemailerProvider);
